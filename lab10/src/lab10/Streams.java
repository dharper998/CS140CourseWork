...
public class Streams {
	private static List<String> someBingoNumbers = Arrays.asList("N40", "n36", "B12", "b6", "G49", "G53", "G60", "G50", "g64", "I26", "i17", "I29", "O71");
	
	public static List<String> grabBingoNums(String letter) {
		return someBingoNumbers.stream()
				.map(e -> e.toUpperCase())
				.filter(e -> (e.substring(0, 1).equals(letter)))
				.sorted()
	...
	public static int countOdd(int[] ints) {
